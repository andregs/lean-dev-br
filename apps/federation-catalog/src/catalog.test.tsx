...
vi.mock('@lean-dev-br/federation-kernel', async (importOriginal) => {
  const orig = await importOriginal<typeof import('@lean-dev-br/federation-kernel')>();
  ...
  return {
    ...
    apiClient: createClient({
      baseUrl: 'http://localhost/labs/federation/api',
